const checkListData = {
  ...
  formaAntPuv: [
    ...
    { id: 9, text: "Envoyer le mail digicode aux parties + l'agence", checked: false },
  ],
  formaAntVente: [
    ...
    { id: 4, text: "Télé@ctes : Vérifier les actes de naissance des parties", checked: false },
    { id: 5, text: "Télé@ctes : Vérifier les actes de mariage des parties", checked: false },
    { id: 6, text: "Télé@ctes : Vérifier le modèle 1 : références cadastrales", checked: false },
    { id: 7, text: "Télé@ctes : Vérifier le modèle 1 : numéro de lots / tantièmes", checked: false },
    ...
    { id: 11, text: "Vérifier le nom des signataires dans le projet AAE (mandataires)", checked: false },
    { id: 12, text: "Si signature à distance, vérifier que le projet AAE a été correctement préparé", checked: false },
    { id: 13, text: "Préparer l'attestation de vente sans prix", checked: false },
    { id: 14, text: "Préparer l'attestation de vente avec prix", checked: false },
    ...
    { id: 18, text: "Si signature à distance, adresser les identifiants au confrère / parties", checked: false },
    { id: 19, text: "Envoyer le mail digicode aux parties + l'agence", checked: false },
    { id: 20, text: "Pointer la réception des fonds", checked: false },
    { id: 21, text: "Vérifier si nous sommes en possession des factures de l'agence / courtier", checked: false },
    { id: 22, text: "Préparer les pièces comptables : virement interne acquéreur -> vendeur", checked: false },
    { id: 23, text: "Préparer les pièces comptables : virement externe vendeur -> vendeur / confrère", checked: false },
    { id: 24, text: "Préparer les pièces comptables : virement externe vendeur -> vendeur", checked: false },
    { id: 25, text: "Préparer les pièces comptables : virement externe agence / courtier", checked: false },
  ],
  formaAntPret: [
    { id: 1, text: "Vérifier que nous sommes en possession de l'offre de prêt signée", checked: false },
    { id: 2, text: "Vérifier que nous sommes en possession des informations relatives aux dates d'échéances", checked: false },
    { id: 3, text: "Vérifier dans l'acte le montant des prêts", checked: false },
    ...
    { id: 6, text: "Vérifier dans l'acte les dates d'échéances des prêts", checked: false },
    { id: 7, text: "Télé@ctes : Vérifier les actes de naissance des parties", checked: false },
    { id: 8, text: "Télé@ctes : Vérifier les actes de mariage des parties", checked: false },
    { id: 9, text: "Télé@ctes : Vérifier le modèle 1 : références cadastrales", checked: false },
