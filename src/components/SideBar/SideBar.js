...
const SideBar = () => {
  ...
  return (
    <nav className="w-32 w-min-32 bg-slate-50 dark:bg-slate-800 min-h-full h-screen flex flex-col items-center pt-5 pb-5 gap-2 drop-shadow-md fixed top-0 left-0">
      <Link to="/" className="font-semibold w-full flex flex-col items-center">
        BotNot <i className="text-xs leading-5 font-semibold bg-slate-400/10 rounded-full py-1 px-3 flex items-center space-x-2 dark:highlight-white/5">Beta</i>
      </Link>
